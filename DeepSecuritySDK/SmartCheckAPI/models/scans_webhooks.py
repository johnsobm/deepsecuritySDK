...
class ScansWebhooks(object):
    ...
    def __init__(self, name=None, hook_url=None, headers=None, secret=None, insecure_skip_verify=None, root_c_as=None, active=None, events=None):  # noqa: E501
        """ScansWebhooks - a model defined in Swagger"""  # noqa: E501
    ...
    @property
    def name(self):
        """Gets the name of this ScansWebhooks.  # noqa: E501

        (optional) A descriptive name for the web hook.   # noqa: E501

        :return: The name of this ScansWebhooks.  # noqa: E501
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this ScansWebhooks.

        (optional) A descriptive name for the web hook.   # noqa: E501

        :param name: The name of this ScansWebhooks.  # noqa: E501
        :type: str
        """
    ...
    @property
    def hook_url(self):
        """Gets the hook_url of this ScansWebhooks.  # noqa: E501


        :return: The hook_url of this ScansWebhooks.  # noqa: E501
        :rtype: str
        """
    ...
    def hook_url(self, hook_url):
        """Sets the hook_url of this ScansWebhooks.


        :param hook_url: The hook_url of this ScansWebhooks.  # noqa: E501
        :type: str
        """
        if hook_url is None:
    ...
    @property
    def headers(self):
        """Gets the headers of this ScansWebhooks.  # noqa: E501
        ...
        :return: The headers of this ScansWebhooks.  # noqa: E501
    ...
    def headers(self, headers):
        """Sets the headers of this ScansWebhooks.

        (optional) You can include your own headers in the web hook request. Use these to provide additional context or authentication information to your web hook receiver.   # noqa: E501

        :param headers: The headers of this ScansWebhooks.  # noqa: E501
    ...
    @property
    def secret(self):
        """Gets the secret of this ScansWebhooks.  # noqa: E501
        ...
        :return: The secret of this ScansWebhooks.  # noqa: E501
        :rtype: str
        """
        return self._secret
    ...
    def secret(self, secret):
        """Sets the secret of this ScansWebhooks.

        (optional) If you provide a `secret` value, then events sent over HTTP will include an `X-Scan-Event-Signature` header that is the SHA-256 HMAC of the event body using your secret as the key.  *This value is write-only: the API will not return the secret or show that it has been set.*   # noqa: E501

        :param secret: The secret of this ScansWebhooks.  # noqa: E501
        :type: str
        """
    ...
    def insecure_skip_verify(self):
        """Gets the insecure_skip_verify of this ScansWebhooks.  # noqa: E501
        ...
        :return: The insecure_skip_verify of this ScansWebhooks.  # noqa: E501
        :rtype: bool
        """
    ...
    def insecure_skip_verify(self, insecure_skip_verify):
        """Sets the insecure_skip_verify of this ScansWebhooks.

        (optional, default: `false`) If `true`, the web hook will not verify TLS connections to the web hook URL. Use this only in controlled environments where you know that connections between the Deep Security Smart Check scanner and the hook URL are secured by other means.   # noqa: E501

        :param insecure_skip_verify: The insecure_skip_verify of this ScansWebhooks.  # noqa: E501
        :type: bool
        """
    ...
    @property
    def root_c_as(self):
        """Gets the root_c_as of this ScansWebhooks.  # noqa: E501
        ...
        :return: The root_c_as of this ScansWebhooks.  # noqa: E501
        :rtype: str
        """
    ...
    def root_c_as(self, root_c_as):
        """Sets the root_c_as of this ScansWebhooks.

        (optional, default: `null`) If present, the web hook will use the provided root CAs as the trusted root CAs for HTTPS web hook requests. The value should be a base-64 encoded list of PEM-encoded certificates. If not present, the web hook will use a set of built-in trusted root CAs. If `insecureSkipVerify` is set to `true`, then the root CAs are not checked.   # noqa: E501

        :param root_c_as: The root_c_as of this ScansWebhooks.  # noqa: E501
        :type: str
        """
    ...
    def active(self, active):
        """Sets the active of this ScansWebhooks.

        (optional, default: `false`). If `true`, the web hook will be invoked whenever a matching event occurs.   # noqa: E501

        :param active: The active of this ScansWebhooks.  # noqa: E501
        :type: bool
        """
    ...
    @property
    def events(self):
        """Gets the events of this ScansWebhooks.  # noqa: E501
        ...
        :return: The events of this ScansWebhooks.  # noqa: E501
        :rtype: list[str]
        """
        return self._events
    ...
    def events(self, events):
        """Sets the events of this ScansWebhooks.

        (optional, default: `[\"*\"]`) If present, this is a list of event types that will be checked before calling the web hook. If the event type matches one of the elements of the list, the web hook will be called. If the list is empty, *all* events will match.   # noqa: E501

        :param events: The events of this ScansWebhooks.  # noqa: E501
        :type: list[str]
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ScansWebhooks):
            return False
