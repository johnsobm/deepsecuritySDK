...
class WebhookRequest(object):
    ...
    @property
    def hook_url(self):
        """Gets the hook_url of this WebhookRequest.  # noqa: E501


        :return: The hook_url of this WebhookRequest.  # noqa: E501
        :rtype: str
        """
    ...
    def hook_url(self, hook_url):
        """Sets the hook_url of this WebhookRequest.


        :param hook_url: The hook_url of this WebhookRequest.  # noqa: E501
        :type: str
        """
        if hook_url is None:
    ...
    @property
    def secret(self):
        """Gets the secret of this WebhookRequest.  # noqa: E501
        ...
        :return: The secret of this WebhookRequest.  # noqa: E501
        :rtype: str
        """
        return self._secret
    ...
    def secret(self, secret):
        """Sets the secret of this WebhookRequest.

        (optional) If you provide a `secret` value, then events sent over HTTP will include an `X-Scan-Event-Signature` header that is the SHA-256 HMAC of the event body using your secret as the key.  *This value is write-only: the API will not return the secret or show that it has been set.*   # noqa: E501

        :param secret: The secret of this WebhookRequest.  # noqa: E501
        :type: str
        """
    ...
    def insecure_skip_verify(self):
        """Gets the insecure_skip_verify of this WebhookRequest.  # noqa: E501
        ...
        :return: The insecure_skip_verify of this WebhookRequest.  # noqa: E501
        :rtype: bool
        """
    ...
    def insecure_skip_verify(self, insecure_skip_verify):
        """Sets the insecure_skip_verify of this WebhookRequest.

        (optional, default: `false`) If `true`, the web hook will not verify TLS connections to the web hook URL. Use this only in controlled environments where you know that connections between the Deep Security Smart Check scanner and the hook URL are secured by other means.   # noqa: E501

        :param insecure_skip_verify: The insecure_skip_verify of this WebhookRequest.  # noqa: E501
        :type: bool
        """
    ...
    @property
    def root_c_as(self):
        """Gets the root_c_as of this WebhookRequest.  # noqa: E501
        ...
        :return: The root_c_as of this WebhookRequest.  # noqa: E501
        :rtype: str
        """
    ...
    def root_c_as(self, root_c_as):
        """Sets the root_c_as of this WebhookRequest.

        (optional, default: `null`) If present, the web hook will use the provided root CAs as the trusted root CAs for HTTPS web hook requests. The value should be a base-64 encoded list of PEM-encoded certificates. If not present, the web hook will use a set of built-in trusted root CAs. If `insecureSkipVerify` is set to `true`, then the root CAs are not checked.   # noqa: E501

        :param root_c_as: The root_c_as of this WebhookRequest.  # noqa: E501
        :type: str
        """
    ...
    def active(self, active):
        """Sets the active of this WebhookRequest.

        (optional, default: `false`). If `true`, the web hook will be invoked whenever a matching event occurs.   # noqa: E501

        :param active: The active of this WebhookRequest.  # noqa: E501
        :type: bool
        """
