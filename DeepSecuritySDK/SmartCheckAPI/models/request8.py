...
class Request8(object):
    ...
    def __init__(self, name=None, description=None, host=None, credentials=None, insecure_skip_verify=None, root_c_as=None, filter=None, schedule=None):  # noqa: E501
        """Request8 - a model defined in Swagger"""  # noqa: E501
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this Request8.

        The name to display for the registry. If not specified, the registry `host` value will be used as the initial name.   # noqa: E501

        :param name: The name of this Request8.  # noqa: E501
        :type: str
        """
    ...
    def description(self):
        """Gets the description of this Request8.  # noqa: E501

        A longer-form note to attach to the registry.   # noqa: E501

        :return: The description of this Request8.  # noqa: E501
        :rtype: str
        """
    ...
    def description(self, description):
        """Sets the description of this Request8.

        A longer-form note to attach to the registry.   # noqa: E501

        :param description: The description of this Request8.  # noqa: E501
        :type: str
        """
    ...
    @host.setter
    def host(self, host):
        """Sets the host of this Request8.

        The host where the registry can be found. Required except when using Amazon Elastic Container Registry.   # noqa: E501

        :param host: The host of this Request8.  # noqa: E501
        :type: str
        """
    ...
    def credentials(self):
        """Gets the credentials of this Request8.  # noqa: E501


        :return: The credentials of this Request8.  # noqa: E501
    ...
    def credentials(self, credentials):
        """Sets the credentials of this Request8.


        :param credentials: The credentials of this Request8.  # noqa: E501
    ...
    def insecure_skip_verify(self):
        """Gets the insecure_skip_verify of this Request8.  # noqa: E501
        ...
        :return: The insecure_skip_verify of this Request8.  # noqa: E501
        :rtype: bool
        """
    ...
    def insecure_skip_verify(self, insecure_skip_verify):
        """Sets the insecure_skip_verify of this Request8.

        If `true`, Deep Security Smart Check will not verify TLS connections to the registry. Use this only in controlled environments where you know that connections between the Deep Security Smart Check scanner and the registry are secured by other means.   # noqa: E501

        :param insecure_skip_verify: The insecure_skip_verify of this Request8.  # noqa: E501
        :type: bool
        """
    ...
    @property
    def root_c_as(self):
        """Gets the root_c_as of this Request8.  # noqa: E501
        ...
        :return: The root_c_as of this Request8.  # noqa: E501
        :rtype: str
        """
    ...
    def root_c_as(self, root_c_as):
        """Sets the root_c_as of this Request8.

        (optional, default: `null`) If present, the service will use the provided root CAs as the trusted root CAs for registry requests. The value should be a base-64 encoded list of PEM-encoded certificates. If not present, the service will use a set of built-in trusted root CAs. If `insecureSkipVerify` is set to `true`, then the root CAs are not checked.   # noqa: E501

        :param root_c_as: The root_c_as of this Request8.  # noqa: E501
        :type: str
        """
    ...
    @property
    def filter(self):
        """Gets the filter of this Request8.  # noqa: E501


        :return: The filter of this Request8.  # noqa: E501
    ...
    def filter(self, filter):
        """Sets the filter of this Request8.


        :param filter: The filter of this Request8.  # noqa: E501
    ...
    @property
    def schedule(self):
        """Gets the schedule of this Request8.  # noqa: E501

        If `true`, this registry will be scheduled for daily re-scan.   # noqa: E501

        :return: The schedule of this Request8.  # noqa: E501
        :rtype: bool
        """
    ...
    def schedule(self, schedule):
        """Sets the schedule of this Request8.

        If `true`, this registry will be scheduled for daily re-scan.   # noqa: E501

        :param schedule: The schedule of this Request8.  # noqa: E501
        :type: bool
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, Request8):
            return False
