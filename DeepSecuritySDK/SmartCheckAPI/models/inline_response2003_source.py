...
class InlineResponse2003Source(object):
    ...
    def __init__(self, type=None, registry=None, repository=None, tag=None, insecure_skip_verify=None, root_c_as=None):  # noqa: E501
        """InlineResponse2003Source - a model defined in Swagger"""  # noqa: E501
    ...
    @property
    def type(self):
        """Gets the type of this InlineResponse2003Source.  # noqa: E501


        :return: The type of this InlineResponse2003Source.  # noqa: E501
        :rtype: str
        """
        return self._type
    ...
    @type.setter
    def type(self, type):
        """Sets the type of this InlineResponse2003Source.


        :param type: The type of this InlineResponse2003Source.  # noqa: E501
        :type: str
        """
        if type is None:
    ...
    @property
    def registry(self):
        """Gets the registry of this InlineResponse2003Source.  # noqa: E501

        (for scan type `docker` only) The registry hostname or IP address.   # noqa: E501

        :return: The registry of this InlineResponse2003Source.  # noqa: E501
        :rtype: str
        """
    ...
    def registry(self, registry):
        """Sets the registry of this InlineResponse2003Source.

        (for scan type `docker` only) The registry hostname or IP address.   # noqa: E501

        :param registry: The registry of this InlineResponse2003Source.  # noqa: E501
        :type: str
        """
    ...
    @property
    def repository(self):
        """Gets the repository of this InlineResponse2003Source.  # noqa: E501

        (for scan type `docker` only) The repository name.   # noqa: E501

        :return: The repository of this InlineResponse2003Source.  # noqa: E501
        :rtype: str
        """
    ...
    def repository(self, repository):
        """Sets the repository of this InlineResponse2003Source.

        (for scan type `docker` only) The repository name.   # noqa: E501

        :param repository: The repository of this InlineResponse2003Source.  # noqa: E501
        :type: str
        """
    ...
    @property
    def tag(self):
        """Gets the tag of this InlineResponse2003Source.  # noqa: E501

        (for scan type `docker` only) The tag of the image to scan.   # noqa: E501

        :return: The tag of this InlineResponse2003Source.  # noqa: E501
        :rtype: str
        """
        return self._tag
    ...
    @tag.setter
    def tag(self, tag):
        """Sets the tag of this InlineResponse2003Source.

        (for scan type `docker` only) The tag of the image to scan.   # noqa: E501

        :param tag: The tag of this InlineResponse2003Source.  # noqa: E501
        :type: str
        """
    ...
    def insecure_skip_verify(self):
        """Gets the insecure_skip_verify of this InlineResponse2003Source.  # noqa: E501
        ...
        :return: The insecure_skip_verify of this InlineResponse2003Source.  # noqa: E501
        :rtype: bool
        """
    ...
    def insecure_skip_verify(self, insecure_skip_verify):
        """Sets the insecure_skip_verify of this InlineResponse2003Source.

        (optional, default: `false`) If `true`, the scan will not verify TLS connections to the source URL. Use this only in controlled environments where you know that connections between the Deep Security Smart Check scanner and the source are secured by other means.   # noqa: E501

        :param insecure_skip_verify: The insecure_skip_verify of this InlineResponse2003Source.  # noqa: E501
        :type: bool
        """
    ...
    @property
    def root_c_as(self):
        """Gets the root_c_as of this InlineResponse2003Source.  # noqa: E501
        ...
        :return: The root_c_as of this InlineResponse2003Source.  # noqa: E501
        :rtype: str
        """
    ...
    def root_c_as(self, root_c_as):
        """Sets the root_c_as of this InlineResponse2003Source.

        (optional, default: `null`) If present, the web hook will use the provided root CAs as the trusted root CAs for HTTPS web hook requests. The value should be a base-64 encoded list of PEM-encoded certificates. If not present, the web hook will use a set of built-in trusted root CAs. If `insecureSkipVerify` is set to `true`, then the root CAs are not checked.   # noqa: E501

        :param root_c_as: The root_c_as of this InlineResponse2003Source.  # noqa: E501
        :type: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, InlineResponse2003Source):
            return False
