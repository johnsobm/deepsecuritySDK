...
class RoleRequest(object):
    ...
    @property
    def name(self):
        """Gets the name of this RoleRequest.  # noqa: E501

        A name for the role.   # noqa: E501

        :return: The name of this RoleRequest.  # noqa: E501
        :rtype: str
        """
        return self._name
    ...
    def name(self, name):
        ...
        :param name: The name of this RoleRequest.  # noqa: E501
        :type: str
        """
        if name is None:
    ...
    def description(self):
        """Gets the description of this RoleRequest.  # noqa: E501

        A description for the role.   # noqa: E501

        :return: The description of this RoleRequest.  # noqa: E501
        :rtype: str
        """
    ...
    def description(self, description):
        """Sets the description of this RoleRequest.

        A description for the role.   # noqa: E501

        :param description: The description of this RoleRequest.  # noqa: E501
        :type: str
        """
    ...
    def policies(self, policies):
        """Sets the policies of this RoleRequest.

        A list of policies for the role. The total size of the policy list must be less than 32768 bytes.   # noqa: E501

        :param policies: The policies of this RoleRequest.  # noqa: E501
