...
class IntegrityMonitoringPolicyExtension(object):
    ...
    @property
    def rule_i_ds(self):
        """Gets the rule_i_ds of this IntegrityMonitoringPolicyExtension.  # noqa: E501

        IDs of the assigned Integrity Monitoring rules.  # noqa: E501

        :return: The rule_i_ds of this IntegrityMonitoringPolicyExtension.  # noqa: E501
        :rtype: list[int]
        """
    ...
    def rule_i_ds(self, rule_i_ds):
        """Sets the rule_i_ds of this IntegrityMonitoringPolicyExtension.

        IDs of the assigned Integrity Monitoring rules.  # noqa: E501

        :param rule_i_ds: The rule_i_ds of this IntegrityMonitoringPolicyExtension.  # noqa: E501
        :type: list[int]
        """
