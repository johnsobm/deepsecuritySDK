...
from DeepSecurityAPI.models.custom_attribute import CustomAttribute  # noqa: F401,E501
...
class ESXSummary(object):
    ...
    def __init__(self, manufacturer=None, model=None, processors=None, processor_type=None, number_of_ni_cs=None, state=None, virtual_machines=None, custom_attributes=None, tpm_enabled=None, tpm_alerts_enabled=None, v_motion_enabled=None, tpm_has_data=None, tpm_last_checked=None):  # noqa: E501
        ...
        if number_of_ni_cs is not None:
            self.number_of_ni_cs = number_of_ni_cs
    ...
    @property
    def number_of_ni_cs(self):
        """Gets the number_of_ni_cs of this ESXSummary.  # noqa: E501

        Number of Network interface controllers the ESX has.  # noqa: E501

        :return: The number_of_ni_cs of this ESXSummary.  # noqa: E501
        :rtype: str
        """
        return self._number_of_ni_cs

    @number_of_ni_cs.setter
    def number_of_ni_cs(self, number_of_ni_cs):
        """Sets the number_of_ni_cs of this ESXSummary.

        Number of Network interface controllers the ESX has.  # noqa: E501

        :param number_of_ni_cs: The number_of_ni_cs of this ESXSummary.  # noqa: E501
        :type: str
        """

        self._number_of_ni_cs = number_of_ni_cs
