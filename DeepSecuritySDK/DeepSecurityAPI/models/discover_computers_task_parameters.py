...
class DiscoverComputersTaskParameters(object):
    ...
    def __init__(self, discovery_type=None, ip=None, scan_discovered_computers=None, resolve_i_ps=None, computer_group_id=None, ipmask=None, iprange_low=None, iprange_high=None):  # noqa: E501
        ...
        if resolve_i_ps is not None:
            self.resolve_i_ps = resolve_i_ps
    ...
    @property
    def resolve_i_ps(self):
        """Gets the resolve_i_ps of this DiscoverComputersTaskParameters.  # noqa: E501

        Automatically resolve IPs to hostnames. Default true. Set false to disable.  # noqa: E501

        :return: The resolve_i_ps of this DiscoverComputersTaskParameters.  # noqa: E501
        :rtype: bool
        """
        return self._resolve_i_ps

    @resolve_i_ps.setter
    def resolve_i_ps(self, resolve_i_ps):
        """Sets the resolve_i_ps of this DiscoverComputersTaskParameters.

        Automatically resolve IPs to hostnames. Default true. Set false to disable.  # noqa: E501

        :param resolve_i_ps: The resolve_i_ps of this DiscoverComputersTaskParameters.  # noqa: E501
        :type: bool
        """

        self._resolve_i_ps = resolve_i_ps
