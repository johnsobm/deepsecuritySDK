...
from DeepSecurityAPI.models.log_files import LogFiles  # noqa: F401,E501
...
class LogInspectionRule(object):
    ...
    attribute_map = {
        ...
        'depends_on_rule_i_ds': 'dependsOnRuleIDs',
        'id': 'ID'
    }

    def __init__(self, name=None, description=None, minimum_agent_version=None, minimum_manager_version=None, type=None, original_issue=None, last_updated=None, identifier=None, template=None, rule_id=None, level=None, groups=None, rule_description=None, pattern=None, pattern_type=None, dependency=None, dependency_rule_id=None, dependency_group=None, frequency=None, time_frame=None, rule_xml=None, log_files=None, alert_enabled=None, alert_minimum_severity=None, recommendations_mode=None, sort_order=None, can_be_assigned_alone=None, depends_on_rule_i_ds=None, id=None):  # noqa: E501
        ...
        self._depends_on_rule_i_ds = None
        self._id = None
        ...
        if depends_on_rule_i_ds is not None:
            self.depends_on_rule_i_ds = depends_on_rule_i_ds
        if id is not None:
            self.id = id
    ...
    @property
    def depends_on_rule_i_ds(self):
        """Gets the depends_on_rule_i_ds of this LogInspectionRule.  # noqa: E501
        ...
        :return: The depends_on_rule_i_ds of this LogInspectionRule.  # noqa: E501
        :rtype: list[int]
        """
        return self._depends_on_rule_i_ds

    @depends_on_rule_i_ds.setter
    def depends_on_rule_i_ds(self, depends_on_rule_i_ds):
        """Sets the depends_on_rule_i_ds of this LogInspectionRule.

        IDs of log inspection rules, separated by commas, that are required by this rule. Ignored if the rule is user-defined, which uses `dependencyRuleID` or `dependencyGroup` instead.  # noqa: E501

        :param depends_on_rule_i_ds: The depends_on_rule_i_ds of this LogInspectionRule.  # noqa: E501
        :type: list[int]
        """

        self._depends_on_rule_i_ds = depends_on_rule_i_ds
